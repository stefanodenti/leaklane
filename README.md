...
<p align="center">
  <a href="https://github.com/stefanodenti/leaklane/releases/tag/v0.3.1-alpha.1"><img alt="Release" src="https://img.shields.io/badge/release-v0.3.1--alpha.1-7ccf9a"></a>
...
[Download LeakLane v0.3.1-alpha.1](https://github.com/stefanodenti/leaklane/releases/tag/v0.3.1-alpha.1)
...
`v0.3.1-alpha.1` is a patch alpha focused on UI/UX polish: richer light/dark surfaces, subtle gradients, improved sidebar and navigation feedback, more dynamic dashboard cards, and a more atmospheric repository map canvas. It is useful for local validation and early feedback, but macOS builds are currently unsigned and not notarized.
